...
- Command Length 128 bytes
- Value length 64 bytes
- 3 tries to read SD card and open files
- Temporary file name is _temp.tem_

Command and value of a setting in C-string, so one character takes one byte, with a NULL character at the end. Therefore 128 bytes can only store 127 characters, though that should be enough for most cases.
...
![Image](https://github.com/cygig/SDConfigCommand/blob/master/flowcharts/SDConfigCommand%20Read%20Config%20(Char%20Analysis)_Page_1.jpg)
![Image](SDConfigCommand Read Config (Char Analysis)_Page_2.jpg)

## Write Config File Flowchart
![Image](SDConfigCommand Write Config (Char Analysis)_Page_1.jpg)
![Image](SDConfigCommand Write Config (Char Analysis)_Page_2.jpg)
